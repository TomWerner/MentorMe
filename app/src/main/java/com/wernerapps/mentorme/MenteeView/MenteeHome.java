...
public class MenteeHome extends ActionBarActivity implements MainView {

    public static final String NAME = "NAME";
    private MainPresenter presenter;
    private TextView welcomeTextView, availableMentorsTextView;
...
//        welcomeTextView = (TextView) findViewById(R.id.welcomeView);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MenteeHome.this, MentorDetail.class);
...
//        welcomeTextView.setText("Welcome, " + name + "!");
    ...
    @Override
    public void setMentors(final List<Mentor> mentorListing) {
        if (mentorListing.size() > 0) {
            listView.setVisibility(View.VISIBLE);
            errorButton.setVisibility(View.GONE);

            MentorAdapter adapter = new MentorAdapter(listView.getContext(), presenter, mentorListing);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    presenter.onItemClicked(mentorListing.get(position));
                }
            });
        }
        else {
